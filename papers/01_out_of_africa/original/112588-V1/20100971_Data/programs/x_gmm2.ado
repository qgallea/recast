...
di _newline
"variable" _col(23) "2SLS Est." _col(39) "2SLS SE" _col(50) 
	"Spatial GMM Est."  _col(68) "Spatial GMM SE"  _col(85) "P>|z| corrected";
di 
"--------" _col(23) "-------------" _col(39) "---------" _col(50) 
	"----------------"  _col(68) "--------------"  _col(85) "---------------";

while `z'<=`xreg'{;
	tempvar beta`z' beta1`z' se`z' see`z' se1`z' se2`z' pvl`z';
	...
	gen `pvl`z''=2*(1-norm(abs(`beta1`z''/`se2`z'')));
	di "`ind`z''" _col(23)  `beta`z''  _col(39)   `see`z''  _col(50) 
	   `beta1`z'' _col(68)  `se2`z''   _col(85)   `pvl`z'';
local z=`z'+1};
end;
