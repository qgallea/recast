...
/*********************************************************************************/
/*** TABLE D12: ROBUSTNESS TO PERCENTAGE OF THE POPULATION OF EUROPEAN DESCENT ***/
/*********************************************************************************/
...
bstat, stat(coef) ;
outreg2 using "results\tableD12", replace tex 
	...
	sortvar(_b_pdiv_aa _b_pdiv_aa_sqr _b_ln_yst_aa _b_ln_arable _b_ln_abslat _b_socinf _b_efrac _b_malfal _b_kgatr _b_distcr _b_peuro _eq2_opt) 
	bdec(3) tdec(3) ;
matrix drop _all ;
scalar drop _all ;
...
bstat, stat(coef) ;
outreg2 using "results\tableD12", tex 
	addstat("Observations", nobs, "R-squared", rsqd) nor2 noobs 
	drop(_b_cons _b_opec _b_legor_uk _b_legor_fr _b_legor_ge _b_legor_so _b_pmuslim _b_pcatholic _b_pprotest _b_europe _b_asia _b_oceania _b_americas _b_wb_ssa)
	sortvar(_b_pdiv_aa _b_pdiv_aa_sqr _b_ln_yst_aa _b_ln_arable _b_ln_abslat _b_socinf _b_efrac _b_malfal _b_kgatr _b_distcr _b_peuro _eq2_opt) 
	bdec(3) tdec(3) ;
...
use "data\country.dta", clear ;
qui reg ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & oecd == 0 ;
scalar nobs = e(N) ;
scalar rsqd = e(r2) ;
get_coef ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & oecd == 0 ;
simulate _b opt = e(eopt), reps(1000) seed(12345):
tse_boot ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & oecd == 0 ;
bstat, stat(coef) ;
outreg2 using "results\tableD12", tex 
	addstat("Observations", nobs, "R-squared", rsqd) nor2 noobs 
	drop(_b_cons _b_opec _b_legor_uk _b_legor_fr _b_pmuslim _b_pcatholic _b_pprotest _b_europe _b_asia _b_oceania _b_americas _b_wb_ssa)
...
use "data\country.dta", clear ;
qui reg ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & western == 0 ;
scalar nobs = e(N) ;
scalar rsqd = e(r2) ;
get_coef ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & western == 0 ;
simulate _b opt = e(eopt), reps(1000) seed(12345):
tse_boot ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & western == 0 ;
bstat, stat(coef) ;
outreg2 using "results\tableD12", tex 
	addstat("Observations", nobs, "R-squared", rsqd) nor2 noobs 
	drop(_b_cons _b_opec _b_legor_uk _b_legor_fr _b_legor_ge _b_legor_so _b_pmuslim _b_pcatholic _b_pprotest _b_europe _b_asia _b_oceania _b_americas _b_wb_ssa)
...
use "data\country.dta", clear ;
qui reg ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
scalar nobs = e(N) ;
scalar rsqd = e(r2) ;
get_coef ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
simulate _b opt = e(eopt), reps(1000) seed(12321):
tse_boot ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
bstat, stat(coef) ;
outreg2 using "results\tableD12", tex 
	addstat("Observations", nobs, "R-squared", rsqd) nor2 noobs 
	drop(_b_cons _b_opec _b_legor_uk _b_legor_fr _b_legor_ge _b_legor_so _b_pmuslim _b_pcatholic _b_pprotest _b_europe _b_asia _b_oceania _b_americas _b_wb_ssa)
...
use "data\country.dta", clear ;
qui reg ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
scalar nobs = e(N) ;
scalar rsqd = e(r2) ;
get_coef ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
simulate _b opt = e(eopt), reps(1000) seed(54345):
tse_boot ln_gdppc2000 pdiv_aa pdiv_aa_sqr ln_yst_aa ln_arable ln_abslat socinf efrac malfal kgatr distcr peuro opec legor_uk legor_fr legor_ge legor_so pmuslim pcatholic pprotest europe asia oceania americas wb_ssa if cleangdp == 1 & europe == 0 ;
bstat, stat(coef) ;
outreg2 using "results\tableD12", tex 
	addstat("Observations", nobs, "R-squared", rsqd) nor2 noobs 
	drop(_b_cons _b_opec _b_legor_uk _b_legor_fr _b_legor_ge _b_legor_so _b_pmuslim _b_pcatholic _b_pprotest _b_europe _b_asia _b_oceania _b_americas _b_wb_ssa)
